...
(define-kaolin-theme modo-dark "Edited monochrome dark green Kaolin theme."
  (
   (bg0 "#0c120f" black0)
   ...
   (
    ...
    (org-level-1         (:foreground teal4 :bold nil))
    (org-level-2         (:foreground spring-green3 :bold nil))
    (org-level-3         (:foreground aquamarine1 :bold nil))
    (org-level-4         (:foreground keyword :bold nil))
    (org-level-5         (:foreground keyword :bold nil))
    (org-level-6         (:foreground keyword :bold nil))
